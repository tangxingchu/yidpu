...
class UserRole extends Component {
    ...
    render() {
        ...
        const { roleList, functionList, userList, roleTreeCheckedKeys, functionExpandedKeys, childUserCheckedKeys,
            saveLoading, loading, reloading, roleFunctions, userName } = this.props.userRole;
            ...
            >
                <Spin spinning={loading}>
                    <Card bordered={false}>
                        ...
                        <Row gutter={24}>
                            <Col span={16}>
                                <Search className={styles.extraContentSearch} placeholder="输入员工姓名或手机号码" value={name} onChange={this.onNameChange} onSearch={(value) => { this.onNameSearch(value) }} />
                                <Table
