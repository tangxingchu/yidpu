                            ...
                            <Card hoverable={getGrade() <= 3} className={`${styles.card} ${getGrade() == 3 ? styles.current : ''}`}>
                                ...
                                <div className={styles.content}>
                                    ...
                                    <div className={styles.userUpdater}>
                                        <div className={styles.info}>￥<span>2888</span>/年</div>
                                        <div className={styles.button}><Button>升级为黄金会员</Button></div>
                                    </div>
                                </div>
                            </Card>
                        </Col>
                        <Col xl={8} lg={12} md={12} sm={24} xs={24} >
                            <Card hoverable={getGrade() <= 4} className={`${styles.card} ${getGrade() == 4 ? styles.current : ''}`}>
                                ...
                                <div className={styles.content}>
                                    ...
                                    <div className={styles.userUpdater}>
                                        <div className={styles.info}>￥<span>3888</span>/年</div>
                                        <div className={styles.button}><Button>升级为钻石会员</Button></div>
                                    </div>
                                </div>
                            </Card>
                        </Col>
