...
export default class InitSteps extends Component {
    ...
    render() {
        const { current, formData, fieldChangeValue, logoOnChange, yyzzOnChange, logoList, yyzzList, photoList, photoOnChange, handleCommit, saveLoading, currMerchantInfo,
