...
class SalesByCategoryChart extends React.Component {
    render() {
        ...
        const { data, salesTotal } = this.props;
            ...
            <div>
                ...
                >
                    ...
                    <Guide>
                        <Html
                            position={["50%", "50%"]}
                            html={`<div style="color:#8c8c8c;text-align: center;width: 10em;">销售额<br>￥<span style="color:#262626;font-size:30px;">${numeral(salesTotal).format("0,0.00")}</span></div>`}
                            alignX="middle"
                            alignY="middle"
                        />
                    </Guide>
