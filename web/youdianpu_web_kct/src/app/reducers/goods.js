...
const initialState = {
    ...
    goodsData: {
        ...
        category: { value: "" }, description: { value: "" }, defaultImage: { value: "" }
    },
    pageSize: 10,
    total: 0,
    currentPage: 1, //当前页
...
const GoodsHandler = {
    ...
    [Goods.SELECT_GOODS_SUCCESS]: (state, action) => {
        const { id, name, piny, unit, costPrice, price, inventory, category, description, defaultImage } = action.payload;
        const goodsData = {
    ...
    [Goods.GOODS_INIT_EXTRAS_SUCCESS]: (state, action) => {
        ...
        const { id, name, piny, unit, costPrice, price, inventory, category, description, defaultImage } = goods;
        const goodsData = {
            id: { value: id }, name: { value: name }, piny: { value: piny }, unit: { value: unit + "" },
            costPrice: { value: costPrice }, price: { value: price },
            inventory: { value: inventory }, category: { value: category },
