...
const staticHost = env === "development" ? "http://127.0.0.1:3015" : "http://static.yidpu.com"; //静态资源服务器地址
...
const memberQRCodeURL = "development" ? "https://m.yidpu.com/member" : "https://m.yidpu.com/member"

export default {
    apiHost,
}

export { rootRouter, staticHost, alipayMerchantAuthRedirectURL, QRCodeURL, memberQRCodeURL }