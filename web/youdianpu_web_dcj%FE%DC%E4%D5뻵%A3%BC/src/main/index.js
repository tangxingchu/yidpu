...
const feedUrl = `http://download.yidpu.com/diancan`; // 更新包位置
//初始化数据库
let mainWindow, tray;
function createTray() {
...
function createWindow() {
    ...
    const url = process.env.NODE_ENV === 'development' ? `http://localhost:3014/` : `http://localhost:30141/`;
    if(process.env.NODE_ENV === 'development') {
