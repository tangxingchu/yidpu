...
Sidebar.prototype.addFloorplans = function(expand) {
	var lineTags = 'line lines connector connectors connection connections arrow arrows ';
	var fns = [
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.wall;fillColor=#000000;', 100, 10, '', '墙壁(水平)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.wall;fillColor=#000000;direction=south;', 10, 100, '', '墙壁(垂直)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.wallCorner;fillColor=#000000;shadow=0;', 100, 100, '', '墙角(西北)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.wallCorner;fillColor=#000000;direction=south;shadow=0;', 100, 100, '', '墙角(东北)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.wallCorner;fillColor=#000000;direction=north;shadow=0;', 100, 100, '', '墙角(西南)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.wallCorner;fillColor=#000000;direction=west;shadow=0;', 100, 100, '', '墙角(东南)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.wallU;fillColor=#000000;shadow=0;', 100, 100, '', '墙壁(U)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.room;fillColor=#000000;shadow=0;', 100, 100, '', '房间'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.window;fillColor=#ffffff;shadow=0;', 100, 10, '', '窗户'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.stairs;shadow=0;fillColor=#ffffff;', 200, 100, '', '楼梯'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.stairs;direction=south;shadow=0;fillColor=#FFFFFF;', 100, 200, '', '楼梯'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.stairsRest;shadow=0;fillColor=#FFFFFF;', 300, 200, '', '楼梯'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.doorLeft;shadow=0;fillColor=#FFFFFF;', 80, 85, '', '单页门(左边)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.doorRight;shadow=0;fillColor=#FFFFFF;', 80, 85, '', '单页门(右边)'),
		this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.doorDouble;shadow=0;fillColor=#FFFFFF;', 160, 85, '', '双开门'),
		// this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.plant;shadow=0;fillColor=#FFFFFF;', 47, 51, '', '植物'),
		// this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.chair;shadow=0;fillColor=#FFFFFF;', 41, 52, '', '凳子'),
		// this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.sofa;shadow=0;fillColor=#FFFFFF;', 90, 80, '', '沙发'),
		// this.addEntry('link hyperlink', mxUtils.bind(this, function()
	 	// {
		// 	var data = this.graph.decompress("");
		// 	var doc = mxUtils.parseXml(data);
		// 	var codec = new mxCodec(doc);
		// 	var cell = codec.decode();

		// 	return this.createVertexTemplateFromCells([cell], 100, 100, 'Link');
			 
		// })),
		// this.addEntry('table', mxUtils.bind(this, function()
	 	// {
	 	// 	var cell = new mxCell('table', new mxGeometry(0, 0, 128, 128), 'image;html=1;labelBackgroundColor=#ffffff;image=/stencils/clipart/Empty_Folder_128x128.png;');
	 	// 	cell.vertex = true;
		// 	this.graph.setAttributeForCell(cell, 'placeholders', '1');
		// 	cell.setAttribute('label', '双击我编辑');
		// 	cell.setAttribute('tableCode', '');//桌子代号
		// 	cell.setAttribute('tableId', '');//桌子ID
		// 	// cell.setAttribute('attribute1', 'value1');
		// 	// this.graph.setAttributeForCell(cell, 'attribute3', 'value3');

	 	// 	return this.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Timestamp');
	 	// })),
	];
// 	console.log(this.graph.compress('<object label="" p1="ppppp" id="2">'
// 	+'<mxCell style="verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.room;fillColor=#000000;shadow=0;" vertex="1" parent="1">'
// 	  +'<mxGeometry x="220" y="150" width="100" height="100" as="geometry"/>'
// 	+'</mxCell>'
//   +'</object>'));
	this.addPaletteFunctions('floorplans', mxResources.get('general'), (expand != null) ? expand : true, fns);
}

Sidebar.prototype.addTables = function(expand) {
	var lineTags = 'line lines connector connectors connection connections arrow arrows ';
	var fns = [
		// this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.plant;shadow=0;fillColor=#FFFFFF;', 47, 51, '', '植物'),
		// this.createVertexTemplateEntry('verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.chair;shadow=0;fillColor=#FFFFFF;', 41, 52, '', '凳子'),
		...
		// })),
		this.addEntry('table1-2', mxUtils.bind(this, function()
	 	{
	 		var cell = new mxCell('table', new mxGeometry(0, 0, 128, 128), 'image;html=1;labelBackgroundColor=#ffffff;image=/stencils/tables/table_1_1.png;direction=north;verticalAlign=middle;labelPosition=center;verticalLabelPosition=middle;align=center;');
	 		cell.vertex = true;
			this.graph.setAttributeForCell(cell, 'placeholders', '1');
			cell.setAttribute('label', '按键即可输入');
			cell.setAttribute('tableCode', '');//桌子代号
			cell.setAttribute('tableId', '');//桌子ID
			cell.setAttribute('tableLimit', '1');//桌子用餐人数1-2人
			// cell.setAttribute('attribute1', 'value1');
			// this.graph.setAttributeForCell(cell, 'attribute3', 'value3');

	 		return this.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '1-2人桌台');
		})),
		this.addEntry('table2-4', mxUtils.bind(this, function()
	 	{
	 		var cell = new mxCell('table', new mxGeometry(0, 0, 128, 128), 'image;html=1;labelBackgroundColor=#ffffff;image=/stencils/tables/table_2_1.png;direction=north;verticalAlign=middle;labelPosition=center;verticalLabelPosition=middle;align=center;');
	 		cell.vertex = true;
			this.graph.setAttributeForCell(cell, 'placeholders', '1');
			cell.setAttribute('label', '按键即可输入');
			cell.setAttribute('tableCode', '');//桌子代号
			cell.setAttribute('tableId', '');//桌子ID
			cell.setAttribute('tableLimit', '2');//桌子用餐人数2-4人
			// cell.setAttribute('attribute1', 'value1');
			// this.graph.setAttributeForCell(cell, 'attribute3', 'value3');

	 		return this.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '2-4人桌台');
		})),
		this.addEntry('table4-6', mxUtils.bind(this, function()
	 	{
	 		var cell = new mxCell('table', new mxGeometry(0, 0, 128, 128), 'image;html=1;labelBackgroundColor=#ffffff;image=/stencils/tables/table_3_1.png;direction=north;verticalAlign=middle;labelPosition=center;verticalLabelPosition=middle;align=center;');
	 		cell.vertex = true;
			this.graph.setAttributeForCell(cell, 'placeholders', '1');
			cell.setAttribute('label', '按键即可输入');
			cell.setAttribute('tableCode', '');//桌子代号
			cell.setAttribute('tableId', '');//桌子ID
			cell.setAttribute('tableLimit', '3');//桌子用餐人数4-6人
			// cell.setAttribute('attribute1', 'value1');
			// this.graph.setAttributeForCell(cell, 'attribute3', 'value3');

	 		return this.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '4-6人桌台');
		})),
		this.addEntry('table6-8', mxUtils.bind(this, function()
	 	{
	 		var cell = new mxCell('table', new mxGeometry(0, 0, 128, 128), 'image;html=1;labelBackgroundColor=#ffffff;image=/stencils/tables/table_4_1.png;direction=north;verticalAlign=middle;labelPosition=center;verticalLabelPosition=middle;align=center;');
	 		cell.vertex = true;
			this.graph.setAttributeForCell(cell, 'placeholders', '1');
			cell.setAttribute('label', '按键即可输入');
			cell.setAttribute('tableCode', '');//桌子代号
			cell.setAttribute('tableId', '');//桌子ID
			cell.setAttribute('tableLimit', '4');//桌子用餐人数6-8人
			// cell.setAttribute('attribute1', 'value1');
			// this.graph.setAttributeForCell(cell, 'attribute3', 'value3');

	 		return this.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '6-8人桌台');
		})),
		this.addEntry('table8-10', mxUtils.bind(this, function()
	 	{
	 		var cell = new mxCell('table', new mxGeometry(0, 0, 128, 128), 'image;html=1;labelBackgroundColor=#ffffff;image=/stencils/tables/table_5_1.png;direction=north;verticalAlign=middle;labelPosition=center;verticalLabelPosition=middle;align=center;');
	 		cell.vertex = true;
			this.graph.setAttributeForCell(cell, 'placeholders', '1');
			cell.setAttribute('label', '按键即可输入');
			cell.setAttribute('tableCode', '');//桌子代号
			cell.setAttribute('tableId', '');//桌子ID
			cell.setAttribute('tableLimit', '5');//桌子用餐人数8-10人
			// cell.setAttribute('attribute1', 'value1');
			// this.graph.setAttributeForCell(cell, 'attribute3', 'value3');

	 		return this.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '8-10人桌台');
		})),
		this.addEntry('table10', mxUtils.bind(this, function()
	 	{
	 		var cell = new mxCell('table', new mxGeometry(0, 0, 128, 128), 'image;html=1;labelBackgroundColor=#ffffff;image=/stencils/tables/table_6_1.png;direction=north;verticalAlign=middle;labelPosition=center;verticalLabelPosition=middle;align=center;');
	 		cell.vertex = true;
			this.graph.setAttributeForCell(cell, 'placeholders', '1');
			cell.setAttribute('label', '按键即可输入');
			cell.setAttribute('tableCode', '');//桌子代号
			cell.setAttribute('tableId', '');//桌子ID
			cell.setAttribute('tableLimit', '6');//桌子用餐人数10人以上
			// cell.setAttribute('attribute1', 'value1');
			// this.graph.setAttributeForCell(cell, 'attribute3', 'value3');

	 		return this.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '10人以上桌台');
		})),
	];
// 	console.log(this.graph.compress('<object label="" p1="ppppp" id="2">'
// 	+'<mxCell style="verticalLabelPosition=bottom;html=1;verticalAlign=top;align=center;shape=mxgraph.floorplan.room;fillColor=#000000;shadow=0;" vertex="1" parent="1">'
...
// 	+'</mxCell>'
//   +'</object>'));
	this.addPaletteFunctions('tables', mxResources.get('tables'), (expand != null) ? expand : true, fns);
}
