...
Actions.prototype.init = function()
{
	...
	this.addAction('open-1', function(){
		ui.openHis(1);
	});
	this.addAction('open-2', function(){
		ui.openHis(2);
	});
	this.addAction('open-3', function(){
		ui.openHis(3);
	});
	this.addAction('open-4', function(){
		ui.openHis(4);
	});
	this.addAction('open-5', function(){
		ui.openHis(5);
	});
	// File actions
	...
	this.addAction('save', function() { ui.saveFile(false); }, true, null, Editor.ctrlKey + '+S').isEnabled = isGraphEnabled;
