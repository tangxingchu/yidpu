                    ...
                    <Col xl={12} lg={24} md={24} sm={24} xs={24}>
                        <Spin spinning={configLoading}>
                            ...
                            >
                                ...
                                <div className={styles.configItem}>2、服务员点餐版App下单是否直接下达后厨打印
                                <Radio.Group disabled={saveConfigLoading["waiter-app-kitchen"]}
                                    buttonStyle="solid"
                                    onChange={(e) => { this.onRadioChange(e, "waiter-app-kitchen") }}>
                                        <Radio.Button value="0" disabled checked={isChecked("waiter-app-kitchen", "0")}>
                                            <Tooltip title="需要在主系统工作台确认之后在下达后厨打印">
                                                否
                                            </Tooltip>
                                        </Radio.Button>
                                ...
                                <div className={styles.configItem}>3、顾客桌台扫码下单是否直接下达后厨打印
                                <Radio.Group disabled={saveConfigLoading["user-app-kitchen"]}
                                    ...
                                    onChange={(e) => { this.onRadioChange(e, "user-app-kitchen") }}>
                                        ...
                                        <Radio.Button disabled value="1" checked={isChecked("user-app-kitchen", "1")}>是</Radio.Button>
                                    </Radio.Group>
                                </div>
                                ...
                                <div className={styles.configItem}>2、[减免或折扣]与现金券是否可以同时享受
                                    <Radio.Group disabled={saveConfigLoading["enabled-subtract-coupon-together"]}
                                        ...
                                        <Radio.Button value="1" disabled checked={isChecked("enabled-subtract-coupon-together", "1")}>是</Radio.Button>
                                    </Radio.Group>
                                </div>
