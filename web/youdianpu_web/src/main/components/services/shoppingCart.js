...
const selectByTableCode = (tableCode) => {
    return db.sql(`select a.id, b.name, b.category,c.category_name as categoryName, d.item_name as unitName,
        b.unit, b.price, a.num, (b.price * a.num) as itemPrice, b.printer_id as printerId, a.goods_id as goodsId, a.remark, a.table_code as tableCode,
        a.create_time as createTime, a.is_printer as isPrinter
...
//离线单修改打印状态
const updatePrinterStatus = (tableCode) => {
    return db.sql(`update shopping_cart set is_printer = 1 where table_code=?`, [tableCode]);
}
