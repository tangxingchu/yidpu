...
Menus.prototype.init = function()
{
	...
	this.put('history', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['open-1', 'open-2', 'open-3', 'open-4', 'open-5'], parent);
	})));
	this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		// this.addMenuItems(menu, ['new', 'open', '-', 'save', 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print'], parent);
		this.addSubmenu('history', menu, parent);
		// this.addMenuItems(menu, ['save', 'import', '-', 'print'], parent);
		this.addMenuItems(menu, ['save', 'import'], parent);
	})));
	...
	this.put('edit', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		...
		this.addMenuItems(menu, ['undo', 'redo', '-', 'cut', 'copy', 'paste', 'delete', '-', 'duplicate', '-',
		                         'edit', '-', 'selectVertices', 'selectAll', 'selectNone', '-', 'lockUnlock']);
	})));
...
Menus.prototype.createPopupMenu = function(menu, cell, evt)
{
	...
	else
	{
		...
		this.addMenuItems(menu, ['-', 'selectVertices',
			'selectAll', '-', 'clearDefaultStyle'], null, evt);
	}
};
