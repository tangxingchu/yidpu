...
import { Modal, Affix, Radio, message, notification, Button, Tag, Tooltip } from 'antd';
                ...
                if(arg) {
                    ...
                    if(autoPrintTicket && autoPrintOrder) {
                        ...
                        selectOrderDetail((cart) => {
                            ipcRenderer.send('printTicket', {cart, merchant: currMerchantUser});
    ...
    render() {
        ...
        return (
            <div className={styles.container} ref={(node) => { this.container = node; }} >
                ...
                <div id="graph" className={styles.graph} style={{ position: 'absolute', top: 92, right: 0, bottom: 0, left: 0 }}>
                </div>
